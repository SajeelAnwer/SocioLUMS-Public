...
const Bottomnavbar = ({navigation, page}) => {
  return (
    <View style={styles.container}>
      ...
      {
        page === "SocietiesList" ?
          <AntDesign name="bars" size={26} color="black" style={styles.activeicon1}
          onPress={()=>navigation.navigate('SocietiesList')}/>
        :
          <AntDesign name="bars" size={26} color="black" style={styles.icon1}
          onPress={()=>navigation.navigate('SocietiesList')}/>
      }
      {
        page === "User_profile" ?
