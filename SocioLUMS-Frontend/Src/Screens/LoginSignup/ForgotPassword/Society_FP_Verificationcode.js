...
export default function Society_FP_Verificationcode({navigation,route}) {

    const {Society_email, verificationcode} = route.params
    ...
    const handleverificationcode = () => {
      ...
      if(code != verificationcode){
        ...
        navigation.navigate('Society_FP_NewPassword', {
