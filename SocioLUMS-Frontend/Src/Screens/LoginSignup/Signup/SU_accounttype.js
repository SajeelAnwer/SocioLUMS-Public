...
export default function SU_accounttype({navigation}) {  
  ...
  const handleaccounttype = () => {
    if(accountType == ""){
      ...
      navigation.navigate('SU_details', {
        account_type: accountType
      })
    }
    else if(accountType == "Society"){
      navigation.navigate('Society_SU_details', {
        account_type: accountType
      })
    }
    else if(accountType == "Sponsor"){
      navigation.navigate('Sponsor_SU_details', {
        account_type: accountType
      })
    }
  }
  
  const navigateToSU_details = () => { navigation.navigate('SU_details')}
  return (
