...
export default function Sponsor_SU_verificationcode({navigation, route}) {
    const {Sponsor_email, verificationcode, Sponsor_name, password, account_type} = route.params
    ...
    const handleverificationcode = () => {
      ...
      if(code != verificationcode){
        ...
        fetch('https://sociolums-backend.up.railway.app/signupsponsor', {
          method: 'post',
          headers: {
