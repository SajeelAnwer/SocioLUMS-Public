...
export default function Society_Changecover({navigation}) {
    
    const [loading, setloading] = useState(false);
    const [Society_cover, setsociety_cover] = useState('');
    ...
    const handlechangecover = () => {
        AsyncStorage.getItem('society').then(data => {
            ...
            .then(url => {
                if(url){
                    fetch('https://sociolums-backend.up.railway.app/societychangecover', {
                        method: 'post',
                        headers: {
