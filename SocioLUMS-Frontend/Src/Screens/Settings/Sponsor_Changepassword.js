...
export default function Sponsor_Changepassword({navigation}) {
    ...
    const handlepasswordchange = ()=>{
        if(!oldpassword || !password || !Password_2){
            ...
            AsyncStorage.getItem('sponsor').then(data => {
                fetch('https://sociolums-backend.up.railway.app/sponsorchangepassword',{
                    method: 'post',
                    headers: {
      ...
      <View style={styles.container}>
        <ImageBackground
          ...
          <Text style={styles.prompt}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('Sponsor_FP_email')}>
